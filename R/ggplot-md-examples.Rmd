...
```{r abia, echo = FALSE}
ABIA = read_csv(here("R/data/ABIA.csv"), show_col_types = FALSE) %>%
...
billboard = read_csv(here(("R/data/billboard.csv")),show_col_types = FALSE) %>%
  select(performer, song, year, week, week_position) %>%
  write_csv(here("R/data/billboard_clean.csv")) %>%
...
olympics_female = read_csv(here("R/data/olympics_clean.csv"), show_col_types = FALSE) %>%
...
swim_avgage_df = data.frame(read_csv(here("R/data/olympics_clean.csv"), show_col_types = FALSE) %>%
...
# split by gender
olympics_ageyr = read_csv(here("R/data/olympics_clean.csv"),show_col_types = FALSE) %>%
  filter(sport == "Swimming") %>%
  group_by(year, sex) %>%
  summarize(avg_age = mean(age))
